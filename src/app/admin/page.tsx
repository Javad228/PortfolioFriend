...
import { Plus, Save, Trash2, Upload, Eye } from 'lucide-react'
...
export default function AdminPage() {
  ...
  const saveConfig = async () => {
    ...
    try {
      ...
      setMessage('✅ Configuration downloaded! Replace the old portfolio-config.json file with this new one.')
    } catch (error) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-pixel-text/80">
            Easy way to manage your pixel art portfolio without coding!
          </p>
          
          {message && (
            <div className="mt-4 p-4 border-2 border-pixel-primary bg-pixel-primary/10 rounded">
              {message}
            </div>
          )}
        </motion.div>
